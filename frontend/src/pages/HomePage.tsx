          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {categories.slice(0, 6).map((category: any) => (
                ...
                >
                  <div className="bg-base-200 rounded-xl p-6 group-hover:bg-primary/10 transition-colors duration-300">
                    <div className="w-12 h-12 bg-primary/20 rounded-lg mx-auto mb-3 flex items-center justify-center group-hover:bg-primary/30 transition-colors">
      ...
      <section className="py-5 bg-base-100">
        <div className="container mx-auto px-4">
          ...
          <RecommendationSection
            ...
            //   </div>
            // }
            products={newArrivals?.recommendations || []}
      ...
      <section className="py-5 bg-base-100">
        <div className="container mx-auto px-4">
          ...
          <RecommendationSection
            ...
            products={trendingProducts?.recommendations || []}
